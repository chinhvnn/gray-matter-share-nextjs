    ...
    var t = {
        ...
        853: function (t, e, i) {
          ...
          function N(t) {
            return 'html' === x(t)
              ? t
              : t.assignedSlot || t.parentNode || (H(t) ? t.host : null) || K(t)
          }
          function U(t) {
          ...
          function et(t) {
            ...
            if (f) {
              ...
              if (
                ...
                (O = o),
                  (b -=
                    (g && x === k && k.visualViewport ? k.visualViewport.height : x[C]) - a.height),
                  (b *= h ? 1 : -1)
              if (c === s || ((c === n || c === o) && d === l))
                (I = r),
                  (m -=
                    (g && x === k && k.visualViewport ? k.visualViewport.width : x[T]) - a.width),
                  (m *= h ? 1 : -1)
            }
            var H,
          ...
          function mt(t, e) {
            ...
            var i = e,
              ...
              P = _t({ reference: H, element: x, strategy: 'absolute', placement: a }),
          ...
          var yt = {
            ...
            fn: function (t) {
              ...
              if (!e.modifiersData[l]._skip) {
                ...
                e.placement !== j &&
                  ((e.modifiersData[l]._skip = !0), (e.placement = j), (e.reset = !0))
              }
            },
                        ...
                        for (var n = 0; n < a.orderedModifiers.length; n++)
                          if (!0 !== a.reset) {
                            var o = a.orderedModifiers[n],
                              ...
                              u = o.name
                            'function' == typeof r &&
                              (a = r({ state: a, options: c, name: u, instance: l }) || a)
                          } else (a.reset = !1), (n = -1)
                      }
                    }
                  },
        ...
        673: function (t, e, i) {
          ...
          var o = i(423),
            r = { htmlEntities: !1, contentType: 'input', onCopy: function () {} },
            s = { id: null, override: !0 },
            a = (function () {
              function t(t, e, i, a) {
                void 0 === t && (t = null),
          ...
          function c() {
            document.querySelectorAll('[data-copy-to-clipboard-target]').forEach(function (t) {
              ...
              i
                ? o.default.instanceExists('CopyClipboard', i.getAttribute('id')) ||
                  new a(t, i, {
